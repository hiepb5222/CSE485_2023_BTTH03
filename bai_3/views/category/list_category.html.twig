                ...
                <table class="table">
                    ...
                    foreach($categories as $category){
                        ...
                        <tr>
                            ...
                            <td><?php echo $category->getSLBaiViet() ?></td>
                            <td >
                                <a href="index.php?controller=category&action=edit&id=<?php echo $category->getMa_tloai()?>" ><i class="fa-solid fa-pen-to-square"></i></a>
                            </td>
                            <td >
                                <a href="index.php?controller=category&action=delete&id=<?php echo $category->getMa_tloai()?>" onclick="return confirm('Bạn có muốn xóa bản ghi hay không?');"><i class="fa-solid fa-trash"></i></a>
                            </td>
                            <!-- <td>
                            </td> -->
                        </tr>
