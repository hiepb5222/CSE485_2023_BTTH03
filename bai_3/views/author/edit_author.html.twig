...
<body>
            ...
            <div class="col-sm">
                ...
                <form action="./index.php?controller=author&action=edit" method="post" enctype="multipart/form-data">
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="txtAuthorId" readonly
                            value="<?php echo $author -> getAuthor_id()?> ">
                    </div>
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="txtAuthorName" required
                            value="<?php echo $author-> getAuthor_name()?>">
                    </div>
    ...
    <footer
        class="bg-white fixed-bottom d-flex justify-content-center align-items-center border-top border-secondary  border-2"
        style="height:80px">
